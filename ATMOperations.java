...
import com.codegnan.customException.NotOperatorException;
...
public class ATMOperations {
	...
	// display the activites performed on the ATM machine
	...
	public static void validateDepositeAmount(double amount)
		...
		if (amount + ATM_MACHINE_BALANCE > 1200000.0d) {
			...
			throw new InsufficientMachineBalanceException("you can't deposite cash as limit of atm machine ");
		}
	}

	// operations avilable on operator mode
	public static void operatorMode(IATMService card) throws InsufficientMachineBalanceException {
		Scanner scanner = new Scanner(System.in);
		double amount;
		boolean flag = true;
		while (flag) {
			...
			case 3:
				...
				System.out.println("=====================================================================");
				System.out.println(
						"===================================user attempts are reset ==================================");
				System.out.println("=====================================================================");
				ACTIVITY.add("Accessed by : " + card.getUserName()
						+ " Activity performed: resetting user pin attempts of user ");
				break;
			case 4:
				checkATMMachineActivities(); // display ATMA activities
				break;
			case 5:
	...
	public static void main(String[] args) throws NotOperatorException, InsufficientMachineBalanceException{
		// initialize the database some sample input data
		dataBase.put(2222222222l, new AxisDebitCard(2222222222l,"yesu",50000.0,2222) );
		...
		while(MACHINE_ON) {
			System.out.println("Pleae enter the debit card number");
				...
				while(true) {
					...
					try {
						...
						case 2:
							...
							ACTIVITY.add("ACCESSED by : " + card.getUserName()+" Activity : amount deposited" +depositeAmount+"from machine");
							break;
						case 3:
							System.out.println("Your account balance is :" +card.checkAmountBalance());
